...
from gtd.settings import IMG_UPLD_DIR, FILE_UPLD_DIR
...
def get_image_path(instance, filename, containing_dir=IMG_UPLD_DIR):
    """
...
def get_file_path(instance, filename):
    ...
    return get_image_path(instance, filename, FILE_UPLD_DIR)
